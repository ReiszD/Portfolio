        ...
        <div className="resume--grid--detail">
          ...
          <div className="resume--grid--detail--data">
            <div className="resume--grid--detail--data--name">
              <h2>
                <ParaWriting stagger={0.08} text={"Reisz Davis"} />
              </h2>
              <h4>
              ...
              <motion.div initial="hidden" animate={controls} variants={blurVariants} transition={{ duration: 1, delay: 0.5 }} onAnimationComplete={() => handleComplete()} className="resume--grid--detail--data--name--icons">
                <a href="https://github.com/ReiszD" target="_blank" rel="noreferrer">
                  <Icon img={githubIcon} />
                </a>
                <a href="https://www.linkedin.com/in/reisz-davis-216522153/" target="_blank" rel="noreferrer">
                  <Icon img={linkedinIcon} />
                </a>
                <a href="https://docs.google.com/document/d/1p_4Q-JAHN49FF6o5Y8L9eV1JYcoYT_on/edit?usp=sharing&ouid=118409008400059219148&rtpof=true&sd=true" target="_blank" rel="noreferrer">
                  <Icon img={fileIcon} />
                </a>
              </motion.div>
            </div>
