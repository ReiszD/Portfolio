      ...
      <div ref={ref} className="about--grid">
        ...
        <motion.div initial="hidden" animate={controls} variants={opacityVariant} transition={{ duration: 1, delay: 2 }} onAnimationComplete={() => handleComplete()} className="about--detail">
          <p className="theme--detail--dark">
            <ScrambleText delay={2}>A versatile frontend software developer with a year experience, specializing in both frontend and fullstack development. Proficient in a broad range of technologies including HTML, CSS, JavaScript, React, TypeScript, Firebase and more. Passionate about building responsive, efficient and user-friendly web applications.</ScrambleText>
          </p>
        </motion.div>
